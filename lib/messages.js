...
// create divider that is width of terminal
...
This program takes a json object local file or the web and allows users to query it.  The results are displayed as JSON objects.  If an input file is NOT supplied, a default json object is used.
